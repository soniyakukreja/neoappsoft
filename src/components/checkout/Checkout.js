    ...
    <div className="row">
      <div className="col-4 px-3 pt-5">
        <ul className="nav navbar-nav text-left nav-bar-style checkout-navbar">
          <Link
            className={`${styles.checkoutTabs} ${styles.enabledLink}`}
            to="/checkout"
          >
            <li>Cart Summary </li>
          </Link>
          {props?.done_check_steps > 0 ? (
            <Link
              className={`${styles.checkoutTabs} ${styles.enabledLink}`}
              to={url + "/address"}
            >
            ...
            <li className={`${styles.checkoutTabs} ${styles.DisabledLink}`}>
              Add Address
            </li>
          )}
          {props?.done_check_steps > 1 ? (
            <Link
              className={`${styles.checkoutTabs} ${styles.enabledLink}`}
              to={url + "/payment"}
            >
