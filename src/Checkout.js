        ...
        <div className="row mt-3">
            ...
            {/* <ul class="nav navbar-nav text-center nav-bar-style checkout-navbar">
             ...
             <ul className="nav navbar-nav text-left nav-bar-style checkout-navbar">
                <Link  className={LinkClass } to="/checkout"><li>Cart Summary</li></Link>
                <Link  className={LinkClass } to={url+"/address"}><li>Add Address</li></Link>
                <Link  className={LinkClass } to={url+"/payment"}><li>Payment</li></Link>
                <Link  className={LinkClass } to={url+"/order"}><li>Order</li></Link>
                </ul>  
            </div>
