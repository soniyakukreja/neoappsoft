...
import ModuleTest from "./footer_pages/ModuleTest";
import ReducerHook from "./footer_pages/ReducerHook";
    ...
    <ErrorBoundary>
      <Router>
        ...
        <Switch>
          ...
          <Route path="/module-test" exact component={ModuleTest} />
          <Route path="/reducer-hook" exact component={ReducerHook} />
